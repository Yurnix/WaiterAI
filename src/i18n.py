...
# Basic i18n (Greek/English) strings used across tabs and UI
STR = {
    "ελ": {
        "chat": "Συνομιλία", "menu": "Μενού", "cart": "Καλάθι", "settings": "Ρυθμίσεις",
        ...
        "must_include": "Πρέπει να περιέχει (υλικά)",
        "must_exclude": "Πρέπει να ΜΗΝ περιέχει (υλικά)",
        "ingredients": "Υλικά", "not_found": "Δεν βρέθηκαν πιάτα.",
    ...
    "en": {
        ...
        "must_include": "Must include (ingredients)",
        "must_exclude": "Must NOT include (ingredients)",
        "ingredients": "Ingredients", "not_found": "No items found.",
